...
Pack everything the night before. Race day mornings are stressful enough. For a one-page printable, see the [Hyrox race-day checklist](/race-day-checklist/).
...
- Grip gloves, if you train in them (chalk on course comes from the event's pans, not your bag)
...
## How early should you arrive at a Hyrox race?

Arrive at the venue **75-90 minutes before your wave** — 90 minutes if you want a full warm-up; 75 minutes is the minimum if you have to cut anything. You need this time for:
...
### Transitions and Roxzone time

The time between finishing a run and starting a station is officially measured as your **Roxzone time** — Hyrox tracks it on your results split alongside run and station splits. Experienced racers treat the Roxzone like part of the race:
...
Saving 20 seconds per transition is roughly 160 seconds, or nearly 3 minutes over the full race. For a deeper breakdown, see [What is Roxzone time?](/blog/what-is-the-hyrox-roxzone/).
...
- [Sample Workouts](/workouts/), ready-to-use training sessions
