...
**Gloves (if used):** Gloves are on the permitted items list, so they are legal at every station. Two conditions attach: they must not be grips, and whatever you wear or carry has to stay with you from start to finish, so you cannot take a pair from someone mid-race. If you train with gloves for grip, bring them. If you do not, do not try them for the first time on race day.
...
There is less to decide here than there used to be. Under the current rulebook you may only use chalk the event supplies, and only at the stations where it is provided, which means the sled pull and the farmers carry. Using your own chalk during the race, or taking chalk away from a station, is a 2-minute penalty each time. Powdered chalk at the wall balls is a separate 2-minute penalty.

So the bag decision is simple: bring liquid chalk if you like, use it on your hands before you go into the corral, and leave the bottle in your bag. Do not carry it. A chalk bottle in a pocket is the single easiest penalty to pick up at a Hyrox, and plenty of packing lists still recommend exactly that.

During the race, plan on the pans at the sled pull and farmers carry, and dry hands everywhere else. Our [full guide to the chalk rules](/blog/is-chalk-allowed-in-hyrox/) covers what changed and how to plan grip around it.
...
- [ ] Hands chalked before the corral, bottle left in the bag
