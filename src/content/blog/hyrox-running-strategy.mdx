...
<figure>
  <img src="/images/blog/running/8x1km-pace-chart-placeholder.png" alt="Chart showing pace per km across 8 Hyrox runs for elite, competitive, and beginner athletes" />
  <figcaption>{/* TODO: replace with our own chart built from results.hyrox.com timing data, ideally pulling 50 athletes per band. */}Pace bands across the 8 runs, sourced from results.hyrox.com Open Men's data. Note how beginner pace decays after Run 4 while elite pace is nearly flat.</figcaption>
</figure>
...
> "Most of my early Hyrox times had me leaving 90 seconds on Run 5. The fix wasn't more mileage. It was three weeks of doing 800 m repeats immediately after a sled push." {/* TODO: replace with real quote from a Hyrox coach in our network or an athlete with a documented improvement curve we can verify on results.hyrox.com. */}
...
Most Hyrox athletes do their "easy" runs too hard. Zone 2 should feel slower than feels right. This is the pace that builds mitochondrial density and aerobic capacity without creating fatigue that steals from your hard sessions. The aerobic-base case is well-documented in [Maffetone's 180-minus-age framework](https://philmaffetone.com/180-formula/) and the [polarised training literature](https://pubmed.ncbi.nlm.nih.gov/24876373/). If in doubt, slow down.

<figure>
  <img src="/images/blog/running/zone2-vs-z3-pace-comparison-placeholder.png" alt="Two GPS pace traces side by side showing the difference between an actual Z2 run and a Z3 run mistaken for Z2" />
  <figcaption>{/* TODO: replace with our own dual GPS export. Strava overlay or Garmin Connect screenshot. */}Two of our team's "easy" runs side by side. The one on the right was supposed to be Z2 and was 25 bpm too high. That single mistake, repeated weekly, caps your race-day ceiling.</figcaption>
</figure>
