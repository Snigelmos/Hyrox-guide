---
title: "Is Hand Taping Allowed in Hyrox? Yes — Unlimited Athletic Tape (2026)"
description: "Yes — hand taping is fully legal in Hyrox. Unlimited athletic tape on palms, fingers, and wrists is allowed. The sled pull is where 90% of hand damage happens — here is the 5-minute pre-race tape job that prevents blisters, the tape brands that work, and what not to use."
pubDate: 2025-10-29
...
Tape and chalk solve different problems, so they work well together. The tape protects skin, chalk improves friction. Apply tape first, on dry skin, then use the chalk pan at the sled pull. Chalking before you tape does not work: chalk stops the tape adhering.

One rule to plan around. Chalk during a race has to be the event's, taken at the station where it is provided, which in practice means the sled pull and the farmers carry. Your own bottle is a 2-minute penalty, as is carrying chalk between stations, and powdered chalk at the wall balls is penalised separately. Tape has no such restriction. See [the chalk rules in full](/blog/is-chalk-allowed-in-hyrox/) if you are building a grip plan around both.
