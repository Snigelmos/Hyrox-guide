...
howToSteps:
  - name: "Step back instead of jumping back"
    text: "On every rep, step one foot back at a time into the plank. Jumping both feet back adds no speed but burns huge amounts of energy over 80 reps."
  ...
  - name: "Hold a metronome rhythm"
    text: "Find one burpee every 3-4 seconds and never break. Steady 80 reps beats hero pace for 20 then a 90-second rest."
---
