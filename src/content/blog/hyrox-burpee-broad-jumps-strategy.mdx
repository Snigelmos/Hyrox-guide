...
series:
  ...
  order: 5
howToName: "How to execute Hyrox burpee broad jumps"
howToSteps:
  - name: "Step back instead of jumping back"
    text: "On every rep, step one foot back at a time into the plank. Jumping both feet back adds no speed but burns huge amounts of energy over the full 80 m."
  - name: "Land the chest softly"
    text: "Control the chest to the floor rather than dropping. A controlled descent uses eccentric strength and spares your shoulders for the final run."
  - name: "Step back up to a low crouch"
    text: "Step your feet forward just enough to stand and jump, you do not need full hip extension. Every centimeter of unnecessary standing up costs time."
  - name: "Jump about 1 meter, no more"
    text: "The standard only requires your toes cross the line. Aim for 1 meter jumps consistently. Ego jumps of 1.5m now mean you fall apart at rep 40."
  - name: "Land soft, absorb with knees"
    text: "Land on the balls of your feet with bent knees. A stiff-legged landing sends shock through your shins and wrecks your next run."
  - name: "Hold a metronome rhythm"
    text: "Find one burpee every 3-4 seconds and never break. A steady pace across the 80 m beats hero pace for 20 reps then a 90-second rest."
---
...
> **Quick reference:** Need the burpee broad jump distance and rules (80 m for all divisions, full chest-to-floor burpee, both feet must leave together on the jump)? See the [Hyrox Burpee Broad Jumps standards page](/stations/burpee-broad-jumps/standards/) for common no-reps and exact specs.
...
See our [station training drills](/training/stations/) and [workouts page](/workouts/) for more programming templates.
...
Next in the series: **[Part 6, Rowing: How to Recover Without Losing Time](/blog/hyrox-rowing-technique/)**. We cover the legs-back-arms drive sequence, why 24 strokes per minute beats 32, and how to use the row as an active-recovery window for the second half.
