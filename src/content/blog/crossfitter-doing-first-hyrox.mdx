...
description: "If you can do Murph, you can finish Hyrox. But you'll likely run out of run engine by station 5. What CrossFit prepares you for, what it doesn't, and a 6-week bridge plan that closes the running gap."
pubDate: 2026-01-21
...
The CrossFit-to-Hyrox transition is one of the cleanest in hybrid sport, with a single clear weakness: most CrossFit programmes don't build the aerobic running engine that Hyrox demands across eight 1 km bouts. Most CrossFit-trained athletes finish their first Hyrox in the 1:20 to 1:35 range — strong but well below their potential. Add 6 to 12 weeks of structured running, and the same athlete can typically race sub-75 (or sub-70) on the strength and engine already in the bank.

If you can do Murph, you can finish Hyrox. But the running deficit will catch most CrossFit Rx athletes around station 5 the first time out.
...
The race-killers that routinely send strong CrossFitters to a 1:32 finish:
...
Rough mapping based on the publicly observable pattern across CrossFit Rx athletes who've completed a first Hyrox with light or no Hyrox-specific prep:
...
Different. Hyrox is longer (60 to 90 minutes vs a typical CrossFit WOD of 8 to 30 minutes) and much more running-heavy. It's harder for the cardiovascular system over time. CrossFit is harder for absolute strength, gymnastics, and short anaerobic capacity. Most athletes who've done both say Hyrox feels harder, mostly because there's nowhere to hide for 70+ minutes.
...
Short term, slightly. Long term, no. Athletes coming back to CrossFit after a Hyrox block routinely report worse Fran times for the first 1–2 weeks, then PRs around the 6-week mark once the lifting volume rebuilds.
