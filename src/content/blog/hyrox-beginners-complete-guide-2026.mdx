...
Hyrox is a global fitness race held in over 50 cities worldwide. The full race-format primer with rules and divisions is in our [What is Hyrox](/racing-guide/what-is-hyrox/) racing guide. Every race follows the same format, in the same order, everywhere in the world:

**8 × 1km runs, each followed by one functional fitness station.**

The stations, in race order:
1. SkiErg — 1000m on a ski erg machine
2. Sled Push — push a weighted sled 50m total (4 × 12.5m)
3. Sled Pull — pull a weighted sled 50m total with a rope
...
7. Sandbag Lunges — lunge 100m total with a sandbag on your back
...
- [All free Hyrox training plans (sub-100 to sub-60, 4 to 12 weeks)](/training-plans/)
