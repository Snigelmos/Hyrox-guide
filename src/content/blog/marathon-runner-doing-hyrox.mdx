...
Marathon runners come into Hyrox with the single most-valuable Hyrox attribute already built: a **trained aerobic engine that can sustain threshold for 60+ minutes**. The pieces missing — sled work, wall balls, grip endurance — are far easier to build than the marathon engine.
