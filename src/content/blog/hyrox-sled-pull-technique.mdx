...
> **Quick reference:** Looking for the official Hyrox sled pull weight by division (Open Men 103 kg, Pro Men 153 kg, Open Women 78 kg, Pro Women 103 kg, all including the sled)? See the [Hyrox Sled Pull standards page](/stations/sled-pull/standards/) for the full breakdown plus common no-reps.
...
- **Chalk:** There is a pan at this station, and it is one of only two places chalk is permitted during a race. Use the event's. Your own bottle is a 2-minute penalty, as is carrying chalk on to the next station. [The chalk rules in full](/blog/is-chalk-allowed-in-hyrox/).
...
Next in the series: **[Part 5, Burpee Broad Jumps: The Race-Maker Station](/blog/hyrox-burpee-broad-jumps-strategy/)**. We cover the step-back burpee, why the jumps don't need to be huge, and a rep scheme that prevents the dreaded mid-station collapse.
