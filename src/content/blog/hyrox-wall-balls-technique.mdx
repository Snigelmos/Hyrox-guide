...
Today: **wall balls**. Station 8. The final station. The only thing between you and the finish line.

Wall balls are brutally simple: you squat, you throw a medicine ball at a target above your head, you catch it, you squat, you throw again. You do this 100 times (men) or 75 times (women). And when you're done — you're done. The race is over.

Except it's the single most common station for the "no-rep spiral": missing the target, being sent back to redo reps, and watching your finish time evaporate.

Let's end the series by making sure that doesn't happen to you.
...
"Break strategy" is the single most important concept for this station. Going unbroken (all 100 in a row) is what elite athletes do — and they can because they've trained it. Almost every Open-level athlete should break the set.
