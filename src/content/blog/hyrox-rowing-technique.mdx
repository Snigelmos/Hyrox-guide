...
> **Quick reference:** Need the row distance and machine spec (1,000 m on a Concept2 RowErg for all divisions)? See the [Hyrox Rowing standards page](/stations/rowing/standards/) for common no-reps and exact specs.
...
Next in the series: **[Part 7, Farmers Carry + Sandbag Lunges: Grip, Legs, and the Point Where You're Allowed to Cry](/blog/hyrox-farmers-carry-sandbag-lunges/)**. We combine stations 6 and 7 into one post because they share the same limiter (grip-and-legs under fatigue) and they land together on race day. Covering: carry posture, lunge mechanics, and the best strategy for "one bad shoulder vs. the other."
