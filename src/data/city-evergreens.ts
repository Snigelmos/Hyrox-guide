...
export const CITY_EVERGREENS: CityEvergreen[] = [
  ...
  },
  {
    ...
    countryCode: "DE",
    citySlug: "berlin",
    tagline: "An iconic venue inside Airport Berlin Tempelhof, and one of the deepest German fields.",
    intro: [
      "Berlin holds a special place in Hyrox history — the first ever Hyrox race ran in Hamburg in 2017, but Berlin became one of the stops that grew the brand. The city's race now runs inside the historic Airport Berlin Tempelhof terminal, the grand finale of the DACH season, and the field includes a high concentration of veteran German athletes who've raced 5+ events.",
      "If you want a bucket-list Hyrox to mark your calendar, the Tempelhof edition is the one.",
    ],
    cityNotes: [
      { title: "Venue", detail: "Airport Berlin Tempelhof — the decommissioned airport terminal in central Berlin. Hyrox lays the running loop inside Hangar 4 and the historic terminal halls: cavernous ceilings, smooth concrete floors, and long sight-line running lanes. One of the most atmospheric venues on the calendar." },
      { title: "Travel", detail: "Nearest stops are U6 to Platz der Luftbrücke or the S-Bahn to Tempelhof. Stay in Kreuzberg or Neukölln for the shortest race-morning commute." },
      { title: "Pacing", detail: "The Tempelhof course is famously fast thanks to long straight running lanes. German waves often go out hard on the SkiErg; if you're not chasing a podium, hold your pace — the front pack burns out by the sled push." },
  ...
  },
  {
    ...
    cityNotes: [
      ...
      { title: "Field", detail: "The Pro Men field is competitive and deep. A sub-65 Open Men finish is genuinely fast here; sub-70 is typically a top-quartile Open result." },
    ],
  },
  {
    slug: "new-york",
  ...
  },
  {
    ...
    tagline: "West Coast Hyrox hub. No LA race on the 2026 calendar — the nearest Southern California stop is Hyrox Anaheim.",
    intro: [
      "Los Angeles has hosted large West Coast Hyrox events at the LA Convention Center, but there is no Hyrox LA race on the 2026 calendar. The nearest Southern California stop in 2026 is Hyrox Anaheim. The LA field has historically skewed toward boutique-fitness crossover athletes — Barry's, Equinox, and SoulCycle members trying their first hybrid race — which made Open more accessible than the Manchester or Berlin equivalent at the same finish time.",
      "If you're based in California or the Pacific Northwest, Hyrox Anaheim is the obvious 2026 A-race choice. The historic LA venue is downtown and walkable from Crypto.com Arena hotels.",
    ],
    cityNotes: [
      { title: "2026 status", detail: "No Hyrox race is scheduled in Los Angeles for 2026 — entries point to Hyrox Anaheim instead. The notes below reflect past LA editions at the Convention Center." },
      ...
      { title: "Field", detail: "LA has been a strong first-Hyrox option for boutique-fitness athletes — the Open field typically ran 10-15 minutes wider in finish-time spread than Berlin or London." },
    ],
  },
  {
    slug: "sydney",
